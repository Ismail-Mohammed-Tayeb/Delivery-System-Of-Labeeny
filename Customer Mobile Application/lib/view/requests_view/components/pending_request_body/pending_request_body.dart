...
class PendingRequestBody extends StatefulWidget {
  PendingRequestBody({Key key}) : super(key: key);
...
class _PendingRequestBodyState extends State<PendingRequestBody> {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: FutureBuilder<List<OrderModel>>(
        future: CartController.getAllInCompleteOrders(),
      ...
      child: ExpansionTile(
        ...
        title: Row(
          ...
          children: [
            ...
            buildAppropriateIconStatus(
                orderModel.orderStatus, orderModel.approximateTimeInMinutes),
            Expanded(
              flex: 3,
              child: Column(
                  ...
                  IntrinsicHeight(
                    child: Row(
                      ...
                      children: [
                        ...
                        Icon(CommunityMaterialIcons.timer_outline),
                        Text(
                          orderModel.approximateTimeInMinutes == null
                              ? 'طلبك قيد الإنتظار'.toString()
                              : 'يصل بعد ' +
                                  orderModel.approximateTimeInMinutes
                                      .toString() +
                                  ' دقيقة',
  ...
  buildAppropriateIconStatus(int status, int approximateTime) {
    return Builder(
