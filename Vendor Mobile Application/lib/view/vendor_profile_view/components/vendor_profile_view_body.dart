...
import '../../../controller/user_data_controller/user_data_controller.dart';
...
class VendorProfileViewBody extends StatefulWidget {
  final bool isEditing;
  VendorProfileViewBody(this.isEditing) : super();

  @override
  _VendorProfileViewBodyState createState() => _VendorProfileViewBodyState();
}

class _VendorProfileViewBodyState extends State<VendorProfileViewBody> {
  String _name;
  File _userImage;
        ...
        child: Column(
          ...
          children: [
            ...
            CustomTextFeild(
              ...
              hintText: AuthenticationController.gbVendorModel.name,
            ...
            CustomTextFeild(
              ...
              rightContentPadding: 1,
              hintText: AuthenticationController.gbVendorModel.phoneNumber,
            ),
            SizedBox(
              height: getProportionateScreenWidth(15),
            ),
                ...
                image: DecorationImage(
                  ...
                  image: _userImage == null
                      ? (AuthenticationController
                                  .gbVendorModel.portraitImageURL ==
                              'null'
                          ? Icon(Icons.person)
  ...
  _updateUserData() async {
    ...
    print('User Id Is ${AuthenticationController.gbVendorModel.userId}');
    setState(() {
      isLoading = !isLoading;
    });
    ...
    if (_name == null) {
      ...
      _name = AuthenticationController.gbVendorModel.name;
      print('name is null');
    }
    bool updateRes;
    if (_userImage == null) {
      ...
      if (updateRes != null && updateRes == true) {
        ...
        AuthenticationController()
            .createGlobalVendorModel((userResult as List).first);
        setState(() {
          isLoading = false;
        });
      }
